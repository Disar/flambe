...
class KhaSound extends BasicAsset<KhaSound>
    implements Sound
{
    ...
    override private function copyFrom (that :KhaSound)
    {
    ...
    implements Tickable
{
    ...
    private function playAudio ()
    {
        ...
        if (KhaPlatform.instance.musicPlaying) {
            return;
        }
        KhaPlatform.instance.musicPlaying = true;
        #end
